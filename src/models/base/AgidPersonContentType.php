 ...
 *
 * @property \open20\agid\person\models\AgidPerson[] $agidPeople
 */
abstract class AgidPersonContentType extends \open20\amos\core\record\Record
{
    ...
    {
        return 'agid_person_content_type';
    }
    ...
    {
        return $this->hasMany(\open20\agid\person\models\AgidPerson::className(), ['agid_person_content_type_id' => 'id']);
    }
}
